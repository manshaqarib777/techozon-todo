...
export default {
    ...
    actions: {
        ...
        todos({
            ...
            return new Promise((resolve, reject) => {
                axios({
                        url: `api/users/${this.state.profile.id}/todos`,
                        method: 'get',
                    })
                    .then(resp => {
        ...
        completeTodo({
            ...
            return new Promise((resolve, reject) => {
                axios({
                        url: `api/users/${this.state.profile.id}/todos/${todo.id}/complete`,
                        method: 'put',
                    })
                    .then(resp => {
                        //commit('makeTodoCompleted', resp.data);
                        dispatch('todos');
                        resolve(resp)
                    })
                    .catch(err => {
        ...
        editTodo({
            ...
            return new Promise((resolve, reject) => {
                axios({
                        url: `api/users/${this.state.profile.id}/todos/${data.id}`,
                        method: 'put',
                        data
                    })
                    .then(resp => {
